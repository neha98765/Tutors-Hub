...
<div>
  ...
  color: #A92A2A;">'.$succs_message.'</div>';
												...
												echo'
											<h2 style="text-align: center;">Update Tuition Informaion</h2>'; ?>
											<div class="itemrow">
											...
											<div class="itemrow">
									  			...
									  			<div style="width: 80%; float: left;">
													...
													<div class="divp50"><input <?php $sub1=strstr($sub, "Group Theory"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Group Theory"><span>Group Theory</span></div>
											...
											<div class="itemrow">
									  		...
									  		<input type="submit" class="sub_button" name="updatetutioninfo" value="Update"/>
											  </br></div><br>
										</div></div>'
								 ?>
							</form>
