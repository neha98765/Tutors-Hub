												...
												if($utype_db == "student"){
													...
													echo '
														<div class="itemrow">
												  			...
												  			<div style="width: 80%; float: left;">
												  				<input type="text" name="inst_name" value="'.$uinst_db.'"/>
												  			</div>
											  			</div>';
												}
											 echo'<input type="submit" class="sub_button" name="updatepic" value="Update"/>
											 <input type="submit" class="sub_button" name="updatepic" style="float: left;" value="Delete"/></br></div><br>
										</div></div>'
								 ?>
							</form>
					</div>
