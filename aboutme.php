				...
				<?php
				 ...
				 ?>
					...
					<?php
						...
						$get_tutor_info = $query2->fetch_assoc();
						$uinsname_db = $get_tutor_info['inst_name'];
						$umedium_db = $get_tutor_info['medium'];
						$usalrange_db = $get_tutor_info['salary'];
						$uclass_db = $get_tutor_info['class'];
						$upresub_db = $get_tutor_info['prefer_sub'];
						$upreloca_db = $get_tutor_info['prefer_location'];
						...
						<div class="p_body">';
							...
							echo '<h2 style="text-align: center;">Tuition Informaion</h2>
							<div class="itemrow">
					  			<div style="width: 20%; float: left;">
					  				<label>Medium: </label>
					  			</div>
