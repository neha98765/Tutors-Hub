				...
				?>
			  	...
			  	<div class="itemrow">
			  			...
			  			<div style="width: 80%; float: left;">
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "Group Theory"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Group Theory"><span>Group Theory</span></div>
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$location.'" placeholder="e.g: Aligarh">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
